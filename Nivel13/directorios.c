...
//Variables golbales para el cache de directorios
 ...
 * 
 * In:  camino: pach completo a crearse el fichero/directorio
...
/* Funcion: mi_dir:
* ---------------------------------------------------------------------
* Esta funcion devuelve el contenido del directorio en el buffer pasado 
* por parametro.
*
...
*
* In:   camino: direccion a se escribir
...
int mi_write(const char *camino, const void *buf, unsigned int offset, unsigned int nbytes)
{
    ...
    int error = 0;
    int are = 0;    //Variable condicional para finalizar bucle
...
*
* In:   camino: direccion donde a leer
*       buffer: buffer del contenido que se a leido
*       offset: bytes de desplazamiento
*       nbytes: tamaño bytes del buffer
*
